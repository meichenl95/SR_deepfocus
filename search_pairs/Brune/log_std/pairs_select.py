...
def main():
    ...
    dirname = '/home/meichen/Research/SR_Attn/pair_events/search_pairs/Brune/log_std'
    spec_dirname = '/home/meichen/work1/SR_Attn/pair_events'
    for phase in ['rgp']:
        pairs_select(dirname=dirname,spec_dirname=spec_dirname,filename='pairsfile_neic_{}_mtspec.csv'.format(phase),ofile='pairsfile_{}_mtspec_select.csv'.format(phase),phase=phase,stnnum=3,upper_fc=0.67,lower_fc=0.05,std_range=0.05,corrcoef=0.0,mag_dif_dif=5)
