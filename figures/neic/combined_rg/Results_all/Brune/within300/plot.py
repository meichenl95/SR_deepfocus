...
ax[0,1].errorbar(S_data[:,6],S_data[:,7],yerr=np.vstack((S_data[:,8],S_data[:,9])),linestyle='',marker='d',markeredgecolor='k',markeredgewidth=0.5,ecolor='k',elinewidth=0.5,markersize=5,markerfacecolor='blue',alpha=0.75)
...
ax[0,1].text(0.75,0.05,'S wave',transform=ax[0,1].transAxes,fontsize=10,color='blue')
...
ax[1,1].errorbar(S_data[:,6],S_data[:,1]*1e-6,yerr=np.vstack((S_data[:,10]*1e-6,S_data[:,11]*1e-6)),linestyle='',marker='d',markeredgecolor='k',markeredgewidth=0.5,ecolor='k',elinewidth=0.5,markersize=5,markerfacecolor='blue',alpha=0.75)
...
ax[1,1].hlines(np.median(S_data[:,1])*1e-6,xmin=6.4,xmax=8.3,linestyles='--',color='blue')
...
ax[1,1].fill_between([6.3,8.4],[8.2,8.2],[324.34,324.34],color='gray',alpha=0.2)
ax[1,1].text(0.05,0.9,'(d)',transform=ax[1,1].transAxes,fontsize=10)
ax[1,1].text(0.75,0.05,'S wave',transform=ax[1,1].transAxes,fontsize=10,color='blue')
...
ax[1,0].fill_between([6.3,8.4],[3.5,3.5],[369.8,369.8],color='gray',alpha=0.2)
